...
namespace _02._LinkedList
{
    internal class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            LinkedListNode<string> node4 = linkedList.AddBefore(node0, "4번 데이터");       //노드 앞에 붙이기
            LinkedListNode<string> node5 = linkedList.AddAfter(node0, "5번 데이터");        //노드 뒤에 붙이기


            // 삭제
            linkedList.Remove("1번 데이터");
            linkedList.Remove(node3);
            linkedList.RemoveFirst();           //앞에 요소 지우기
            linkedList.RemoveLast();            //뒤에 요소 지우기
